...
export default class Translation {
     ...
     * console.log(translation.translate('hello_name', 'John', 'Doe', 'Foo')); // Bonjour John Doe
     */
    translate(toTranslate, ...args) {
        try {
            const translatedString = this._allTranslations.find(translation => translation.language === this._currentLanguage).allTranslations[toTranslate];
            if (translatedString === undefined) {
                return '__MISSING_TRANSLATION_' + toTranslate;
            }
            return this._parserInstance.parse(translatedString, ...args);
        }
        catch (error) {
